			...
			<div class="mb-3 row">
				...
				<div class="col-sm-10">
					<input type="password" class="form-control" id="passwd"
						name="passwd" placeholder="비밀번호를 입력해주세요">
				</div>
			</div>
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-10">
					<input type="password" class="form-control" id="passwd2"
						name="passwd2" placeholder="비밀번호를 입력해주세요">
				</div>
			</div>
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control mb-2" id="address"
						name="address" placeholder="주소를 입력해주세요"> <input
						type="text" class="form-control" id="detailaddress"
						name="detailaddress" placeholder="상세주소를 입력해주세요">
				</div>
			</div>
				...
				<div class="col-sm-10 d-flex align-items-center">
					<div class="form-check me-3">
						<input class="form-check-input" type="radio" name="sex"
							id="btn-male" value="남" checked> <label
							class="form-check-label" for="btn-male">남자</label>
					</div>
					<div class="form-check">
						<input class="form-check-input" type="radio" name="sex"
							id="btn-female" value="여"> <label
							class="form-check-label" for="btn-female">여자</label>
					</div>
				</div>
			</div>
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-10">
					<input type="tel" class="form-control" id="phonenumber"
						name="phonenumber" placeholder="휴대전화번호를 입력해주세요">
				</div>
			</div>
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-10">
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="checkbox" name="habit"
							value="수영" id="check-swim"> <label
							class="form-check-label" for="check-swim">수영</label>
					</div>
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="checkbox" name="habit"
							value="등산" id="check-hiking"> <label
							class="form-check-label" for="check-hiking">등산</label>
					</div>
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="checkbox" name="habit"
							value="게임" id="check-game"> <label
							class="form-check-label" for="check-game">게임</label>
					</div>
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="checkbox" name="habit"
							value="런닝" id="check-running"> <label
							class="form-check-label" for="check-running">런닝</label>
					</div>
				</div>
			</div>
...
/*		//자동으로
		 	...
		 	if (validUseridButton) {
		 	  validUseridButton.addEventListener("click", () => {
		 	    const userid = getUserid.value.trim();
		 	...
		 	const validEmailButton = document.querySelector("#validEmailButton");
		 	...
		 	if (validEmailButton) {
		 		validEmailButton.addEventListener("click", () => {
		 	  ...
		 	  const emailPattern = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
		 	    ...
		 	    .then(j => {
		 	      if (j.existEmail) {
		 	    	 alert("[" + email + "] 해당 이메일은 사용 불가능 합니다 ");
		 	    	validEmailClicked = false;
		 	      } else {
		 	    	 alert("[" + email + "] 해당 이메일은 사용 가능 합니다 ");
