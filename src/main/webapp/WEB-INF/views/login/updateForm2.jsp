...
<form name="updateForm" id="updateForm"  action="update2" method="post">
  ...
  <div class="col-sm-10">
	...
	<!-- 버튼 -->
      <div class="text-end">
        ...
        <button type="button" class="btn btn-outline-secondary ms-2" onclick="location = '${pageContext.request.contextPath}/detailView?userid=' + userid.value">
        내 정보 보기 </button>
	 		...
	 		updateForm.addEventListener("submit", e => {
			  ...
			  .then(json => {
				  if (json.status == "error") {
					  ...
					  alert("회원정보가 수정되었습니다");
					  location = "${pageContext.request.contextPath}/detailView?userid=" + userid.value; //el 구문을 사용한 절대 경로 표기법  
				  }
			   });
